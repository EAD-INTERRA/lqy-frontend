<template>
  <section class="hero custom-container bg h-[100vh] p-[16px]  md:p-[64px] lg:p-[64px] xl:py-[64px] xl:px-[198px]">
    <div class="w-full md:w-full mx-auto">
      ...
      <div
        class="bg-white shadow-lg rounded-[8px] mt-[40%] md:mt-0 p-[24px] sm:py-[64px] sm:px-[198px] md:py-[64px] md:px-[98px] lg:px-[198px]">
        <h3 class="customOrange pb-2 justify-center text-center font-ubuntu text-3xl font-bold">
          Application Pending!!!
        </h3>
        <!-- <hr class="pb-6" /> -->
        <div>
          <p class="font-ubuntu text-xl text-center leading-normal font-normal text-black">"Thank you for registering!
