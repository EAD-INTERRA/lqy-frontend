<template>
    <div class="p-4 pt-[50px] space-y-6 ">
            <div class="text-xl text-[#FF0000] font-semibold mb-4">Management Fee Earned by Financial Institution</div>
        ...
        <section class="grid grid-cols-4 w-full gap-6">
            ...
            <div class=" bg-white shadow-lg flex gap-6 rounded-[12px] w-full px-[30px] py-[16px]">
                ...
                <div>
                    <p class="font-ox text-ox-xs">Proportion of funds (%)</p>
            ...
            <div class="bg-white shadow-lg flex gap-6 rounded-[12px] w-full px-[30px] py-[16px]">
                ...
                <div>
                    <p class="font-ox text-ox-xs">Management Fee Earned</p>
