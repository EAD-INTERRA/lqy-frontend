<template>
  <div class="px-4 space-y-6 overflow-y-auto">
      ...
      <div class="p-[0.9px]" v-if="activeTab === 2">
        <button @click="activeTab = 4"
          ...
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M9.99935 4.16699V10.0003M9.99935 10.0003V15.8337M9.99935 10.0003H15.8327M9.99935 10.0003H4.16602"
    ...
    <InvestorPortfolio v-if="activeTab === 3" @go-back="activeTab = 1" :investor="investor" :cashDrawn="cashDrawn"
      :chnNo="chnNo" :accNo="accNo" :vasSec="vasSec" :mlv="mlv" :slv="slv" :interestM="interestM"
      :interestS="interestS" />

    <Investors v-if="activeTab === 2" :headers="headers" @open-details="handleOpenDetails" />
    <create-investor v-if="activeTab === 4" @go-back="activeTab = 2" />
    <ViewInvestor v-if="activeTab === 5" @go-back="activeTab = 2" />
  </div>
</template>
