        ...
        <div class="space-y-4">
          <div class="flex items-center justify-between py-3 rounded-[8px] p-3 bg-gray-50">
            ...
            <div class="flex items-center gap-4">
              <span class="hidden md:block text-sm text-gray-500">04:00 PM</span>
              <span class="hidden md:block px-2 py-1 bg-orange-100 text-orange-800 text-xs rounded">Pending</span>
