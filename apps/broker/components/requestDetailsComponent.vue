      ...
      <section class="mb-6 grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="space-y-6">
          ...
          <div class="bg-white shadow-custom-heavy p-5 rounded-[16px]">
            ...
            <p>
              Lorem ipsum dolor sit, amet consectetur adipisicing elit. Officia iusto laboriosam blanditiis consequuntur nihil impedit delectus dolorem optio provident iure omnis, labore quia ratione ea nam voluptates dicta officiis. Quod.
            </p>
          </div>
        </div>
