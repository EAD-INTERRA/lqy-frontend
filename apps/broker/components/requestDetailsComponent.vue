  ...
  <div class="mx-auto p-4">
    ...
    <div class="flex justify-between">
      <div class="mb-4">
        ...
        <span class="text-gray-600">{{ props.chn }}</span>
      </div>
    ...
    <section class="mb-6 grid grid-cols-1 md:grid-cols-2 gap-6">
      <div class="space-y-6">
        ...
        <div class="bg-white shadow-custom-heavy p-5 rounded-[16px]">
          ...
          <div class="grid grid-cols-2 font-ub font-medium gap-3 py-4">
            <div>
              <h3 class="text-[14px]">CHN Number</h3>
              <span class="text-[20px]">{{ props.chn }}</span>
            </div>
            <div>
              <h3 class="text-[14px]">Amount Requested</h3>
              <span class="text-[20px]">&#8358; {{ props.creditLineAmount.toLocaleString() }}</span>
            </div>
            <div>
              <h3 class="text-[14px]">Date Submitted</h3>
              <span class="text-[20px]">{{ props.dateSubmitted }}</span>
            </div>
          </div>
        </div>
        ...
        <div class="bg-white shadow-custom-heavy p-5 rounded-[16px]">
          ...
          <p>
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Officia iusto laboriosam blanditiis consequuntur
            nihil impedit delectus dolorem optio provident iure omnis, labore quia ratione ea nam voluptates dicta
            officiis. Quod.
          </p>
        </div>
      </div>
      ...
      <!-- Status Timeline -->
      <!-- Status Timeline -->
      <div class="bg-white shadow-custom-heavy p-5 rounded-[16px] h-fit">
        <h3 class="font-ox font-bold text-black/85 text-[16px] mb-4 border-b border-gray-300 py-2">
          Status Timeline
        </h3>
